...
### Goals
1. Mengembangkan sistem rekomendasi Content-Based Filtering yang dapat merekomendasikan anime berdasarkan karakteristik konten
2. Mengembangkan sistem rekomendasi Collaborative Filtering yang dapat merekomendasikan anime berdasarkan preferensi pengguna lain
3. Mengevaluasi performa kedua sistem rekomendasi menggunakan metrik yang sesuai
...
1. Drop missing rating: Diperlukan untuk content-based filtering yang menggunakan rating sebagai fitur
2. Filter rating -1: Rating -1 menandakan user tidak memberikan rating numerik
3. Filter common anime: Memastikan konsistensi antara kedua dataset
4. Minimum threshold: Mengurangi sparsity dan noise dalam collaborative filtering
''')
...
1. Sistem berhasil diimplementasikan dengan dua pendekatan berbeda
2. Content-based filtering cocok untuk mengatasi cold start problem
3. Collaborative filtering memberikan rekomendasi yang lebih personal
4. Kombinasi kedua metode (hybrid approach) dapat memberikan hasil yang lebih optimal

SARAN PENGEMBANGAN:
- Implementasi hybrid recommendation system
- Penambahan fitur seperti tahun rilis, studio, dll
- Optimisasi algoritma untuk dataset yang lebih besar
